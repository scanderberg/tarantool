...
$('body').delegate('textarea#id<?php echo $block->searchID(0); ?>','keyup',function(){
textFill = $('textarea#id<?php echo $block->searchID(0); ?>').attr('value');
$('textarea#id<?php echo $block->searchID(0); ?>').html(textFill);
});

$('body').delegate('textarea#id<?php echo $block->searchID(0); ?>','focus',function(){
...
$('textarea#id<?php echo $block->searchID(0); ?>').css('font-size', textFont).css('color', colorFont).css('background-color', colorBackgr);
});

$('body').delegate('div.bolder','click',function(){
$("textarea#id<?php echo $block->searchID(0); ?>").toggleClass("bold");
});

$('body').delegate('div.italer','click',function(){
$("textarea#id<?php echo $block->searchID(0); ?>").toggleClass("ital");
});

$('body').delegate('div.underer','click',function(){
$("textarea#id<?php echo $block->searchID(0); ?>").toggleClass("under");
});


$('body').delegate('div.brokener','click',function(){
$("textarea#id<?php echo $block->searchID(0); ?>").toggleClass("broke");
});

$('body').delegate('div#alignleft<?php echo $block->searchID(0); ?>','click',function(){
$("textarea#id<?php echo $block->searchID(0); ?>").toggleClass("aleft");
});

$('body').delegate('div#aligncenter<?php echo $block->searchID(0); ?>','click',function(){
$("textarea#id<?php echo $block->searchID(0); ?>").toggleClass("acenter");
});

$('body').delegate('div#alignright<?php echo $block->searchID(0); ?>','click',function(){
$("textarea#id<?php echo $block->searchID(0); ?>").toggleClass("aright");
});

$('body').delegate('div.overer','click',function(){
$("textarea#id<?php echo $block->searchID(0); ?>").toggleClass("over");
});

$('body').delegate('div.delstyle','click',function(){
$("textarea#id<?php echo $block->searchID(0); ?>").removeClass("bold");
$("textarea#id<?php echo $block->searchID(0); ?>").removeClass("ital");
$("textarea#id<?php echo $block->searchID(0); ?>").removeClass("under");
$("textarea#id<?php echo $block->searchID(0); ?>").removeClass("broke");
$("textarea#id<?php echo $block->searchID(0); ?>").removeClass("acenter");
$("textarea#id<?php echo $block->searchID(0); ?>").removeClass("aright");
$("textarea#id<?php echo $block->searchID(0); ?>").removeClass("over");
$("textarea#id<?php echo $block->searchID(0); ?>").removeClass("aleft");
});
...
$("div.content").append("<div class='addtext'><div class='alignleft'  id='alignleft<?php echo $block->searchID(0); ?>' data-toggle='tooltip' title='По левому краю' data-placement='top'><img src='img/align_left.png' height='14px'/></div><div class='aligncenter' id='aligncenter<?php echo $block->searchID(0); ?>' data-toggle='tooltip' title='По цетру' data-placement='top'><img src='img/align_center.png' height='14px'/></div><div class='alignright' data-toggle='tooltip' title='По правому краю' data-placement='top'><img src='img/align_right.png' height='14px'/></div><div class='bolder' data-toggle='tooltip' title='жирный' data-placement='top'>B</div><div class='italer' data-toggle='tooltip' title='курсив' data-placement='top'>I</div><div class='underer' data-toggle='tooltip' title='подчёркнутый' data-placement='top'>U</div><div class='brokener' data-toggle='tooltip' title='зачёркнутый' data-placement='top'>C</div><div class='overer' data-toggle='tooltip' title='черта вверху' data-placement='top'>K</div><div class='delstyle' data-toggle='tooltip' title='сброс стилей' data-placement='top'>A<span>x</span></div><input type='text' name='font' class='font' placeholder='Шрифт' data-toggle='tooltip' title='Размер шрифта' data-placement='top' /><input type='text' name='color' class='color' placeholder='Цвет' data-toggle='tooltip' title='Цвет текта' data-placement='top' /><input type='text' name='backgr' class='backgr' placeholder='Background' data-toggle='tooltip' title='Заливка' data-placement='top' /><div class='set-font' data-toggle='tooltip' title='Сохранить' data-placement='top'>OK</div><div class='capter'><textarea class='capter' id='id<?php echo $block->searchID(0); ?>'>Текст</textarea></div></div>");
