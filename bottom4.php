...
$("div#bolder<?php echo $block->searchID($f); ?>, div#italer<?php echo $block->searchID($f); ?>, div#underer<?php echo $block->searchID($f); ?>, div#brokener<?php echo $block->searchID($f); ?>, div#delstyle<?php echo $block->searchID($f); ?>, div#alignleft<?php echo $block->searchID($f); ?>, div#aligncenter<?php echo $block->searchID($f); ?>, div#alignright<?php echo $block->searchID($f); ?>, div#overer<?php echo $block->searchID($f); ?>, div#set-font<?php echo $block->searchID($f); ?>, input#font<?php echo $block->searchID($f); ?>, input#color<?php echo $block->searchID($f); ?>, input#backgr<?php echo $block->searchID($f); ?>").css("display","none");
});
...
$('body').delegate('textarea#id<?php echo $block->searchID($f); ?>','focus',function(){
$("div#bolder<?php echo $block->searchID($f); ?>, div#italer<?php echo $block->searchID($f); ?>, div#underer<?php echo $block->searchID($f); ?>, div#brokener<?php echo $block->searchID($f); ?>, div#delstyle<?php echo $block->searchID($f); ?>, div#alignleft<?php echo $block->searchID($f); ?>, div#aligncenter<?php echo $block->searchID($f); ?>, div#alignright<?php echo $block->searchID($f); ?>, div#overer<?php echo $block->searchID($f); ?>, div#set-font<?php echo $block->searchID($f); ?>, input#font<?php echo $block->searchID($f); ?>, input#color<?php echo $block->searchID($f); ?>, input#backgr<?php echo $block->searchID($f); ?>").css("display","inline-block");
});
...
$.post('http://vobber.ru/ajax-elem.php', { url: newContent, project: newProject, zop: randomAjax1, block: nextTextarea, projectID: <?php echo $block->searchID(0); ?> });
}
updateContent();
